...
<section class="kependudukan-section">
    <div class="container reveal">
        ...
        <div class="row g-2 g-md-3 justify-content-center">
            ...
            <div class="col-6 col-lg-3">
                <a href="{{ $settings['link_statistik_keluarga'] && $settings['link_statistik_keluarga'] != '#' ? $settings['link_statistik_keluarga'] : route('statistik.show', 'keluarga') }}" class="kpd-card">
        ...
        <div class="row g-3 mt-3 justify-content-center">
            <div class="col-4 col-md-2">
                <a href="{{ $settings['link_agama'] && $settings['link_agama'] != '#' ? $settings['link_agama'] : route('statistik.show', 'agama') }}" class="kpd-card kpd-card-sm">
                    <div class="kpd-icon gold"><i class="bi bi-person-hearts"></i></div>
                    <div class="kpd-label">Agama</div>
                </a>
            </div>
            <div class="col-4 col-md-2">
                <a href="{{ $settings['link_pekerjaan'] && $settings['link_pekerjaan'] != '#' ? $settings['link_pekerjaan'] : route('statistik.show', 'pekerjaan') }}" class="kpd-card kpd-card-sm">
                    <div class="kpd-icon gold"><i class="bi bi-briefcase-fill"></i></div>
                    <div class="kpd-label">Pekerjaan</div>
                </a>
            </div>
            <div class="col-4 col-md-2">
                <a href="{{ $settings['link_pendidikan'] && $settings['link_pendidikan'] != '#' ? $settings['link_pendidikan'] : route('statistik.show', 'pendidikan') }}" class="kpd-card kpd-card-sm">
                    <div class="kpd-icon gold"><i class="bi bi-mortarboard-fill"></i></div>
                    <div class="kpd-label">Pendidikan</div>
                </a>
            </div>
            <div class="col-4 col-md-2">
                <a href="{{ $settings['link_umur'] && $settings['link_umur'] != '#' ? $settings['link_umur'] : route('statistik.show', 'umur') }}" class="kpd-card kpd-card-sm">
                    <div class="kpd-icon gold"><i class="bi bi-calendar-check-fill"></i></div>
                    <div class="kpd-label">Umur</div>
                </a>
            </div>
            <div class="col-4 col-md-2">
                <a href="{{ $settings['link_perkawinan'] && $settings['link_perkawinan'] != '#' ? $settings['link_perkawinan'] : route('statistik.show', 'perkawinan') }}" class="kpd-card kpd-card-sm">
                    <div class="kpd-icon gold"><i class="bi bi-heart-fill"></i></div>
                    <div class="kpd-label">Perkawinan</div>
                </a>
            </div>
            <div class="col-4 col-md-2">
                <a href="{{ $settings['link_wilayah'] && $settings['link_wilayah'] != '#' ? $settings['link_wilayah'] : route('statistik.show', 'wilayah') }}" class="kpd-card kpd-card-sm">
