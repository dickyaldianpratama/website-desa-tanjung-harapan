...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
    ...
    <div class="d-grid d-md-block">
        <a href="{{ route('admin.fasilitas.create') }}" class="btn btn-primary px-4 py-2 text-nowrap" style="background: linear-gradient(135deg, #c9963a 0%, #a67828 100%); border: none; border-radius: 12px; font-weight: 600; box-shadow: 0 4px 15px rgba(201, 150, 58, 0.3); transition: transform 0.2s; text-align: center;">
