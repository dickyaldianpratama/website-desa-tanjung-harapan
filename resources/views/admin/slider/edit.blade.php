        ...
        <div class="row g-4">
            <div class="col-md-8">
                <div class="mb-3">
                    ...
                    <input type="text" name="judul" class="form-control form-control-lg @error('judul') is-invalid @enderror" value="{{ old('judul', $slider->judul) }}" maxlength="60">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="subtitle" class="form-control @error('subtitle') is-invalid @enderror" rows="3" maxlength="150">{{ old('subtitle', $slider->subtitle) }}</textarea>
                    <small class="text-muted" style="font-size: 0.75rem;">Maksimal 150 karakter.</small>
                    @error('subtitle') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                
                <div class="mb-3">
                    <label class="form-label fw-bold">Gambar Banner Utama</label>
                    <div class="text-center p-4 border border-dashed rounded mb-2 bg-light" id="imagePreviewContainer" style="border-width: 2px; cursor: pointer;" onclick="document.getElementById('gambar').click()">
                        @if($slider->gambar)
                            <img id="imagePreview" src="{{ asset('images/sliders/' . $slider->gambar) }}" alt="Preview" class="img-fluid rounded" style="width: 100%; max-height: 400px; object-fit: cover;">
                        @else
                ...
                <div class="card bg-light border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="urutan" class="form-control @error('urutan') is-invalid @enderror" value="{{ old('urutan', $slider->urutan) }}" min="1" required>
