...
<div class="card-admin p-4">
    <form action="{{ route('admin.lembaga.store') }}" method="POST" enctype="multipart/form-data" id="lembagaForm">
        @csrf
        <div class="row g-4">
            <div class="col-md-8">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select name="tipe" class="form-select @error('tipe') is-invalid @enderror" required>
                        ...
                        <option value="BPD" {{ old('tipe') == 'BPD' ? 'selected' : '' }}>Badan Permusyawaratan Desa (BPD)</option>
                        <option value="PKK" {{ old('tipe') == 'PKK' ? 'selected' : '' }}>Tim Penggerak PKK</option>
                    </select>
...
<script>
    ...
    document.getElementById('cropModal').addEventListener('hidden.bs.modal', function () {
        ...
        // Kosongkan input file jika batal dan belum ada foto sebelumnya
