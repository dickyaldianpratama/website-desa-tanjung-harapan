                ...
                <div class="card bg-light border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kategori" list="kategori-list" class="form-control @error('kategori') is-invalid @enderror" value="{{ old('kategori') }}" required placeholder="Ketik atau pilih kategori...">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="text-center p-4 border border-dashed rounded mb-2 bg-white" id="imagePreviewContainer" style="border-width: 2px; cursor: pointer;" onclick="document.getElementById('gambar').click()" title="Klik untuk import gambar">
                                ...
                                <p class="text-muted small mt-2 mb-0" id="uploadText">Klik area ini untuk memilih gambar utama</p>
